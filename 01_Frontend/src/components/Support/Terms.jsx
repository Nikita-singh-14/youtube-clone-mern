    ...
    return (
        <>
            <div className='flex flex-col justify-center items-center bg-gray-800 p-4 gap-4 px-60 min-h-screen'>
                <a className='text-blue-400 cursor-pointer'>Current as of 01 Sept 2026</a>
                <h2 className='text-white text-2xl'>Terms and conditions</h2>
                <p className='text-white'>By accessing our website, you are agreeing to be bound by these terms of service, and agree
